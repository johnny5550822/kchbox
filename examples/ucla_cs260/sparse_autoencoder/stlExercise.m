...
mnistData   = loadMNISTImages('mnist/train-images.idx3-ubyte');%784*60000
mnistLabels = loadMNISTLabels('mnist/train-labels.idx1-ubyte');

% Set Unlabeled Set (All Images)

% Simulate a Labeled and Unlabeled set
labeledSet   = find(mnistLabels >= 0 & mnistLabels <= 4);   %30596
...
testFeatures = feedForwardAutoencoder(opttheta, hiddenSize, inputSize, ...
                                       testData);
%%
display_network(trainFeatures(:,1:100));
%%======================================================================
