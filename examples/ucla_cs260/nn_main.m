...
numClasses = 2;
hiddenLayersSize = [5]; % numel(hiddenLayersSize) = number of hidden layers
...
hh = plotROC(probs,true_label);
%saveas(hh,'image.jpg');

%% Step 4. Write the result to a text file
