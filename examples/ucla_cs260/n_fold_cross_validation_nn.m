% n-fold cross validation for neural network. Split the data into n sets. Take out (n-1) and
...
function [acc,sen,spec,pre,recall,f_measure,mcc,confusion_matrix] ...
    = n_fold_cross_validation_nn(fv, label, n, numClasses,hiddenLayersSize,...
    ...
    for nn = 1:n
        ...
        pred_validation = kchbox_nn(validation_data,train_data,train_label, ...
